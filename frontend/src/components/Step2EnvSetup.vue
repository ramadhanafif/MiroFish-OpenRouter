              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First run? Switch to Custom and lower the rounds — you'll get a quick preview with less risk of errors ➝</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        addLog('Configuration generating — polling for completion...')
        startConfigPolling()
      }
    }
  } catch (err) {
